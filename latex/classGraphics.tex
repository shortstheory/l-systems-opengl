...
Takes the centre of the circle as x0, y0 values, and the radius of the circle. The circle is rendered using the mid-\/point algorithm. \index{Graphics@{Graphics}!draw\+Line@{draw\+Line}}
...
Draws a line on the viewport given the starting point and ending point. This function uses Bresenham\textquotesingle{}s line drawing algorithm for rendering clearly and efficiently.
